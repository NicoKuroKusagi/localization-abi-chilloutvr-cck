    ...
    public class Russian
    {
        public static readonly Dictionary<string, string> Localization = new Dictionary<string, string>()
        {
            ...
            },
            {
                ...
                "В мире не заданы стартовые позиции. Пожалуйста добавьте одну или несколько позиций в компоненте CVRWorld, иначе будет использоваться поциция объекта с CVRWorld."
            },
            {
            ...
            {"ABI_UI_ASSET_INFO_ATTACH_BUTTON", "Присоединить guid"},
            {
                ...
                "Настраивает позицию в которой будет находится камера игрока. Она должна быть между глаз."
            },
            {
                "ABI_UI_AVATAR_INFO_VOICE_POSITION",
                "Настраивает позицию из которой слашен голос в игре. Она должна быть около рта."
            },
            {
