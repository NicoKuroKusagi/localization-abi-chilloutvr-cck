...
namespace ABI.CCK.Scripts.Translation
{
    public class Russian
    {
        public static readonly Dictionary<string, string> Localization = new Dictionary<string, string>()
        {
            ...
            { "ABI_UI_BUILD_RUNTIME_FILEINFO_PANO1K", "Размер 1080P файла панорамного изображения" },
            { "ABI_UI_BUILD_RUNTIME_FILEINFO_PANO4K", "Размер 4K файла панорамного изображения" },
